...
if __name__ == "__main__":
    ...
    parser.add_argument('--env',         default='flock',           type=str,             choices=['leaderfollower', 'flock', 'meetup'],      help='Task (default: flock)', metavar='')
    ...
    parser.add_argument('--workers',     default=2,                 type=int,                                                                 help='Number of RLlib workers (default: 0)', metavar='')
    ...
    # wandb.login()
    run = wandb.init(
        project=f'Drone-Swarm',
        entity="danielemos",
        config=conf_dict,
        sync_tensorboard=True,  # auto-upload sbFlockAviary3's tensorboard metrics
